...
AWS_BUCKET_EAP = 'udemys3bucket123'
...
if __name__ == '__main__':
    ...
    # s3_resource.Object(AWS_BUCKET_EAP, 'KilroySchematic.svg').delete()

    pythonusecase = s3_resource.Bucket(name=AWS_BUCKET_EAP)
    for object in pythonusecase.objects.all():
        print(object.key)

    s3_resource.Object(AWS_BUCKET_EAP, 'DynamoDB_Samplefile.json'). \
        upload_file(Filename='C:\\Users\\epohl\\projects\\s3bucket_playground\\DynamoDB_Samplefile.json')
